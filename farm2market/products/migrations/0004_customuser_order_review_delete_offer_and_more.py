    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='products.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='products.customuser')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='product',
            name='farmer',
            field=models.ForeignKey(default=2, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='products.customuser'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='order',
